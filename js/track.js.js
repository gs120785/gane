...
var initialSrc = "https://track.trendyreview.shop/" + campaignID + "?format=json";
...
setTimeout(function() {
    if (!urlParams.get('rtkcid')) {
        ...
        xhr.onreadystatechange = function() {
            if (xhr.readyState == 4 && xhr.status == 200) {
                ...
                document.querySelectorAll('a').forEach(function(el) {
                    if (el.href.indexOf("track.trendyreview.shop/click") > -1) {
                ...
                xhrr.open("GET", "https://track.trendyreview.shop/view?clickid=" + rawData.clickid)
                xhrr.send();
            }
        }
        ...
        xhrTrack.open("GET", "https://track.trendyreview.shop/view?clickid=" + rtkClickID)
        xhrTrack.send();
        document.querySelectorAll('a').forEach(function(el) {
            if (el.href.indexOf("track.trendyreview.shop/click") > -1) {
                if (el.href.indexOf('?') > -1) {
